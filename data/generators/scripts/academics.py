...
for i in range(N):
    ...
    # Historial de notas (por semestre) - Ruido aumentado para realismo
    grades = []
    for t in range(1, sem + 1):
        gpa_t = 4.0 - 0.05 * (t - 1) + ability + rng.normal(0, 0.35)
    ...
    # Asistencia (%) - Mayor variabilidad para realismo
    asist = 85 - 20 * desertor + rng.normal(0, 18)
